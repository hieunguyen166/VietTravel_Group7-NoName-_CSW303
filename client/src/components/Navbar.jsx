...
const Navbar = ({setShowLogin}) => {
    ...
    return (
        ...
        src={assets.logo1} 
        alt="logo" 
        className="h-10 md:h-12 w-auto object-contain scale-[2.2] origin-left -translate-x-3 md:-translate-x-5"
    ...
    />
            ...
            max-sm:p-4 transition-all duration-300 z-50 ${location.pathname === "/" ? "bg-transparent" : "bg-light"} ${open ? "max-sm:translate-x-0" : "max-sm:translate-x-full"}`}>
